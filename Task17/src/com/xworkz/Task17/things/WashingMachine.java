...
public WashingMachine(String name,String manufacturedLocation,String type,String brand,double price,double Capacity,String[] colors,String[] paymentType,double[] ratings,
...
public void display()
{
	...
	System.out.println("type of the WashingMachine:"+type);
	System.out.println("Brand:"+brand);
	System.out.println("price:"+price);
	System.out.println("capacity:"+Capacity);
	
	System.out.println("WashingMachine colors");
	...
	System.out.println("WashingMachine paymentType ");
	...
	System.out.println("WashingMachine ratings ");
	...
	for (int i = 0; i < this.ratings.length; i++)
	{
		...
		System.out.println("WashingMachine quality ");

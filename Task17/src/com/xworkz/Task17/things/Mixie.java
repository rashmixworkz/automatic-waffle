...
public Mixie(String name,String manufacturedLocation,String type,String brand,double price,String Capacity,String[] colors,String[] paymentType,double[] ratings,
...
public void display()
{
	System.out.println("name of the Mixie:"+name);
	System.out.println("location:"+manufacturedLocation);
	System.out.println("type of the Mixie:"+type);
	System.out.println("Brand:"+brand);
	System.out.println("price:"+price);
	System.out.println("capacity:"+Capacity);
	
	System.out.println("Mixie colors");
	...
	System.out.println("Mixie paymentType ");
	...
	System.out.println("Mixie ratings ");
	...
	for (int i = 0; i < this.ratings.length; i++)
	{
		...
		System.out.println("Mixie quality ");
